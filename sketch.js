...
function draw() {
  ...
  if(GAMESTATE === play_INSTRUCTION) {
    ...
    text("SPACESHIP CAN ALSO SHOOT YOU....",width/10.5,height-height/2.1);
...
if(enemyBulletGrp.isTouching(computerplayer)) {
  enemyBulletGrp.destroyEach()
  player_Friend_Life = player_Friend_Life-1;
}

if(asteroidsGrp.isTouching(computerplayer)) {
  asteroidsGrp.destroyEach()
  player_Friend_Life = player_Friend_Life-1;
}

if(enemyGroup.isTouching(computerplayer)) {
  enemyGroup.destroyEach()
  player_Friend_Life = player_Friend_Life-1;
}

if(enemyGroup1.isTouching(computerplayer)) {
  enemyGroup1.destroyEach()
  player_Friend_Life = player_Friend_Life-1;
}
